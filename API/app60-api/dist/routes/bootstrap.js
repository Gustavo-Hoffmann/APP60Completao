 ...
 */
export function bootstrapRouter(pool) {
    const r = Router();
    r.post("/first-super-admin", async (req, res) => {
        ...
        try {
            ...
            await pool.query(`INSERT INTO app_users (cognito_sub, email, full_name, role, is_active, primary_institution_id)
         VALUES ($1, $2, $3, 'SUPER_ADMIN', true, NULL)`, [cognitoSub, email.trim().toLowerCase(), fullName.trim()]);
